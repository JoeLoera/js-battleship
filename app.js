...
function startGame() {
  if (playerTurn === undefined) {
    if (optionContainer.children.length != 0) {
      infoDisplay.textContent = "Please place all your first!";
    } else {
...
function handleClick(e) {
  if (!gameOver) {
    ...
    playerTurn = false;
    const allBoardBlocks = document.querySelectorAll("#compuiter div");
...
if (playerSunkShips.length === 5) {
  infoDisplay.textContent = "You sunk aoo of the computers ships! You WON!";
  gameOver = true;
}
